...
export function links() {
  return [{ rel: "stylesheet", href: styles }, { rel: "stylesheet", href: 'https://rsms.me/inter/inter.css'}];
}

export let meta = () => {
  return {
    title: "Remix Architect Template",
    description: "Insert your site description here!"
  };
};
    ...
    <Document title="Error!">
      <Layout>
        <div>
          ...
          <hr />
          <p>
            Whoops! We've encountered an error, please refresh and we'll be right back!
          </p>
        </div>
      </Layout>
    </Document>
